...
save_windowsize_and_cleanup (void)
{
	...
	g_free (xlogdir);
	if (remotetimer_7311 != -1)
		g_source_remove (remotetimer_7311);

	if (sockettimer_2333 != -1)
		g_source_remove (sockettimer_2333);
	if (sockettimer_7311 != -1)
		g_source_remove (sockettimer_7311);
