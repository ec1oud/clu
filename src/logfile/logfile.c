/*
   ...
   Copyright (C) 2012 - 2017 Andy Stewart KB1OIQ <kb1oiq@arrl.net>
...
static const gint field_widths[] = {
	8, 15, 8, 8, 15, 15, 15, 15, 15, 30, 8, 8, 8, 30, 30, 8, 30, 30, 80
};
