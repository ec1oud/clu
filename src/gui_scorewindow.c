/*
   ...
   Copyright (C) 2012 - 20200 Andy Stewart <kb1oiq@arrl.net>
...
notebook_append_awardpage (GtkWidget *scorewindow, GtkWidget *awardsnotebook, const gchar *treeviewname, const gchar *tabname, const gchar *windowname)
{
	...
	column = gtk_tree_view_column_new_with_attributes
		("0.472", renderer, "text", BAND_630, NULL);
	gtk_tree_view_append_column (GTK_TREE_VIEW (awardtreeview), column);
	gtk_tree_view_column_set_visible
		(column, preferences.scoringbands[BAND_630]);
	...
	column = gtk_tree_view_column_new_with_attributes
		("40", renderer, "text", BAND_8, NULL);
	gtk_tree_view_append_column (GTK_TREE_VIEW (awardtreeview), column);
	gtk_tree_view_column_set_visible
		(column, preferences.scoringbands[BAND_8]);
	...
	column = gtk_tree_view_column_new_with_attributes
		("54", renderer, "text", BAND_5, NULL);
	gtk_tree_view_append_column (GTK_TREE_VIEW (awardtreeview), column);
	gtk_tree_view_column_set_visible
		(column, preferences.scoringbands[BAND_5]);
...
create_scorewindow (void)
{
	...
	column = gtk_tree_view_column_new_with_attributes
		("0.472", renderer, "text", BAND_630 + 1, NULL);
	gtk_tree_view_append_column (GTK_TREE_VIEW (countrytreeview), column);
	gtk_tree_view_column_set_visible
		(column, preferences.scoringbands[BAND_630]);
	...
	column = gtk_tree_view_column_new_with_attributes
		("5", renderer, "text", BAND_60 + 1, NULL);
	gtk_tree_view_append_column (GTK_TREE_VIEW (countrytreeview), column);
	gtk_tree_view_column_set_visible
		(column, preferences.scoringbands[BAND_60]);
	...
	column = gtk_tree_view_column_new_with_attributes
		("40", renderer, "text", BAND_8 + 1, NULL);
	gtk_tree_view_append_column (GTK_TREE_VIEW (countrytreeview), column);
	gtk_tree_view_column_set_visible
		(column, preferences.scoringbands[BAND_8]);
	...
	column = gtk_tree_view_column_new_with_attributes
		("54", renderer, "text", BAND_5 + 1, NULL);
	gtk_tree_view_append_column (GTK_TREE_VIEW (countrytreeview), column);
	gtk_tree_view_column_set_visible
		(column, preferences.scoringbands[BAND_5]);
