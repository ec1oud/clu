/*
   ...
   Copyright (C) 2017 Andy Stewart <kb1oiq@arrl.net>
...
static GtkActionEntry entries[] =
{
  ...
  { "Sort Date", GTK_STOCK_SORT_ASCENDING, N_("Sort by Date"), "<control><shift>O", "Sort log by date", G_CALLBACK(on_sort_log_date_activate) },
  { "Sort Call", GTK_STOCK_SORT_ASCENDING, N_("Sort by Callsign"), "<control><shift>R", "Sort log by callsign", G_CALLBACK(on_sort_log_callsign_ascending_activate) },
...
"</ui>";
	...
	GLADE_HOOKUP_OBJECT (window, hrsthbox, "hrsthbox");
	...
	GLADE_HOOKUP_OBJECT (window, mrsthbox, "mrsthbox");
