...
(_("Add calculated bearing and distance fields when the locator log field is used"));
	...
	bb2 = gtk_check_button_new_with_label ("0.472 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb2),
		preferences.scoringbands[BAND_630]);
	gtk_box_pack_start (GTK_BOX (leftvbox), bb2, FALSE, FALSE, 0);

	bb3 = gtk_check_button_new_with_label ("0.501 MHz");
	...
	bb4 = gtk_check_button_new_with_label ("1.8 MHz");
	...
	bb5 = gtk_check_button_new_with_label ("3.5 MHz");
	...
	bb6 = gtk_check_button_new_with_label ("5 MHz");
	...
	bb7 = gtk_check_button_new_with_label ("7 MHz");
	...
	bb8 = gtk_check_button_new_with_label ("10 MHz");
	...
	bb9 = gtk_check_button_new_with_label ("14 MHz");
	...
	bb10 = gtk_check_button_new_with_label ("18 MHz");
	...
	bb11 = gtk_check_button_new_with_label ("21 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb11),
		preferences.scoringbands[BAND_15]);
	gtk_box_pack_start (GTK_BOX (leftvbox), bb11, FALSE, FALSE, 0);

	middlevbox = gtk_vbox_new (FALSE, 0);
	gtk_box_pack_start (GTK_BOX (framehbox), middlevbox, FALSE, FALSE, 0);

	bb12 = gtk_check_button_new_with_label ("24 MHz");
	...
	bb13 = gtk_check_button_new_with_label ("28 MHz");
	...
	bb14 = gtk_check_button_new_with_label ("40 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb14),
		preferences.scoringbands[BAND_8]);
	gtk_box_pack_start (GTK_BOX (middlevbox), bb14, FALSE, FALSE, 0);

	bb15 = gtk_check_button_new_with_label ("50 MHz");
	...
	bb16 = gtk_check_button_new_with_label ("54 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb16),
		preferences.scoringbands[BAND_5]);
	gtk_box_pack_start (GTK_BOX (middlevbox), bb16, FALSE, FALSE, 0);
  
	bb17 = gtk_check_button_new_with_label ("70 MHz");
	...
	bb18 = gtk_check_button_new_with_label ("144 MHz");
	...
	bb19 = gtk_check_button_new_with_label ("222 MHz");
	...
	bb20 = gtk_check_button_new_with_label ("420 MHz");
	...
	bb21 = gtk_check_button_new_with_label ("902 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb21),
		preferences.scoringbands[BAND_33CM]);
	gtk_box_pack_start (GTK_BOX (middlevbox), bb21, FALSE, FALSE, 0);

	bb22 = gtk_check_button_new_with_label ("1240 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb22),
		preferences.scoringbands[BAND_23CM]);
	gtk_box_pack_start (GTK_BOX (middlevbox), bb22, FALSE, FALSE, 0);

	bb23 = gtk_check_button_new_with_label ("2300 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb23),
		preferences.scoringbands[BAND_13CM]);
	gtk_box_pack_start (GTK_BOX (middlevbox), bb23, FALSE, FALSE, 0);

	rightvbox = gtk_vbox_new (FALSE, 0);
	gtk_box_pack_start (GTK_BOX (framehbox), rightvbox, FALSE, FALSE, 0);

	bb24 = gtk_check_button_new_with_label ("3300 MHz");
	...
	bb25 = gtk_check_button_new_with_label ("5650 MHz");
	...
	bb26 = gtk_check_button_new_with_label ("10000 MHz");
	...
	bb27 = gtk_check_button_new_with_label ("24000 MHz");
	...
	bb28 = gtk_check_button_new_with_label ("47000 MHz");
	...
	bb29 = gtk_check_button_new_with_label ("75500 MHz");
	...
	bb30 = gtk_check_button_new_with_label ("120000 MHz");
	...
	bb31 = gtk_check_button_new_with_label ("142000 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb31),
		preferences.scoringbands[BAND_2MM]);
	gtk_box_pack_start (GTK_BOX (rightvbox), bb31, FALSE, FALSE, 0);

	bb32 = gtk_check_button_new_with_label ("241000 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb32),
		preferences.scoringbands[BAND_1MM]);
	gtk_box_pack_start (GTK_BOX (rightvbox), bb32, FALSE, FALSE, 0);

	bb33 = gtk_check_button_new_with_label ("300000 MHz");
	gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (bb33),
		preferences.scoringbands[BAND_SUBMM]);
	gtk_box_pack_start (GTK_BOX (rightvbox), bb33, FALSE, FALSE, 0);
	...
	if (response == GTK_RESPONSE_OK)
	{
		...
		preferences.scoringbands[BAND_630] = check ? 1 : 0;
		...
		preferences.scoringbands[BAND_8] = check ? 1 : 0;
		...
		preferences.scoringbands[BAND_5] = check ? 1 : 0;
		...
		check = gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON(bb31));
		preferences.scoringbands[BAND_2MM] = check ? 1 : 0;

		check = gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON(bb32));
		preferences.scoringbands[BAND_1MM] = check ? 1 : 0;

		check = gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON(bb33));
		...
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_2190 + 1), preferences.scoringbands[BAND_2190]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_630 + 1), preferences.scoringbands[BAND_630]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_560 + 1), preferences.scoringbands[BAND_560]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_160 + 1), preferences.scoringbands[BAND_160]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_80 + 1), preferences.scoringbands[BAND_80]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_60 + 1), preferences.scoringbands[BAND_60]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_40 + 1), preferences.scoringbands[BAND_40]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_30 + 1), preferences.scoringbands[BAND_30]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_20 + 1), preferences.scoringbands[BAND_20]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_17 + 1), preferences.scoringbands[BAND_17]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_15 + 1), preferences.scoringbands[BAND_15]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_12 + 1), preferences.scoringbands[BAND_12]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_10 + 1), preferences.scoringbands[BAND_10]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_8 + 1), preferences.scoringbands[BAND_8]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_6 + 1), preferences.scoringbands[BAND_6]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_5 + 1), preferences.scoringbands[BAND_5]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_4 + 1), preferences.scoringbands[BAND_4]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_2 + 1), preferences.scoringbands[BAND_2]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_125CM + 1), preferences.scoringbands[BAND_125CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_70CM + 1), preferences.scoringbands[BAND_70CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_33CM + 1), preferences.scoringbands[BAND_33CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_23CM + 1), preferences.scoringbands[BAND_23CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_13CM + 1), preferences.scoringbands[BAND_13CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_9CM + 1), preferences.scoringbands[BAND_9CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_6CM + 1), preferences.scoringbands[BAND_6CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_3CM + 1), preferences.scoringbands[BAND_3CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_12HMM + 1), preferences.scoringbands[BAND_12HMM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_6MM + 1), preferences.scoringbands[BAND_6MM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_4MM + 1), preferences.scoringbands[BAND_4MM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_2HMM + 1), preferences.scoringbands[BAND_2HMM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_2MM + 1), preferences.scoringbands[BAND_2MM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_1MM + 1), preferences.scoringbands[BAND_1MM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(countrytreeview), BAND_SUBMM + 1), preferences.scoringbands[BAND_SUBMM]);

		dxcctreeview = lookup_widget (scorewindow, "dxcctreeview");
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_2190), preferences.scoringbands[BAND_2190]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_630), preferences.scoringbands[BAND_630]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_560), preferences.scoringbands[BAND_560]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_160), preferences.scoringbands[BAND_160]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_80), preferences.scoringbands[BAND_80]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_60), preferences.scoringbands[BAND_60]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_40), preferences.scoringbands[BAND_40]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_30), preferences.scoringbands[BAND_30]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_20), preferences.scoringbands[BAND_20]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_17), preferences.scoringbands[BAND_17]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_15), preferences.scoringbands[BAND_15]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_12), preferences.scoringbands[BAND_12]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_10), preferences.scoringbands[BAND_10]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_8), preferences.scoringbands[BAND_8]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_6), preferences.scoringbands[BAND_6]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_5), preferences.scoringbands[BAND_5]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_4), preferences.scoringbands[BAND_4]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_2), preferences.scoringbands[BAND_2]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_125CM), preferences.scoringbands[BAND_125CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_70CM), preferences.scoringbands[BAND_70CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_33CM), preferences.scoringbands[BAND_33CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_23CM), preferences.scoringbands[BAND_23CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_13CM), preferences.scoringbands[BAND_13CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_9CM), preferences.scoringbands[BAND_9CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_6CM), preferences.scoringbands[BAND_6CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_3CM), preferences.scoringbands[BAND_3CM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_12HMM), preferences.scoringbands[BAND_12HMM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_6MM), preferences.scoringbands[BAND_6MM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_4MM), preferences.scoringbands[BAND_4MM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_2HMM), preferences.scoringbands[BAND_2HMM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_2MM), preferences.scoringbands[BAND_2MM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_1MM), preferences.scoringbands[BAND_1MM]);
		gtk_tree_view_column_set_visible (gtk_tree_view_get_column (GTK_TREE_VIEW(dxcctreeview), BAND_SUBMM), preferences.scoringbands[BAND_SUBMM]);
	}
