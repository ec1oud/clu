...
void on_sort_log_date_activate (GtkMenuItem *menuitem, gpointer user_data);
void on_sort_log_callsign_ascending_activate (GtkMenuItem *menuitem, gpointer user_data);
